    ...
    cards:
      ...
      - type: custom:mushroom-template-card
        ...
        primary: |
          ...
          {% endif %}
        secondary: >
          {% set s = states('sensor.bms_felicity_battery_status') | lower %} {{ 'Discharge Current' if s ==
      ...
      - type: custom:mushroom-template-card
        ...
        primary: |
          ...
          {% endif %}
        secondary: >
          {% set s = states('sensor.bms_felicity_battery_status') | lower %} {{ 'Discharge Power' if s ==
